...
/**
 * Classes and menus for itop-request-mgmt-itil (version 3.0.2)
 *
...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_DefineStimulus(new StimulusInternal("ev_approve", array()));
		MetaModel::Init_DefineStimulus(new StimulusInternal("ev_reject", array()));
		...
		MetaModel::Init_DefineStimulus(new StimulusInternal("ev_wait_for_approval", array()));
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'service_details' => OPT_ATT_NORMAL,
				),
			)
		);
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'service_details' => OPT_ATT_READONLY,
				),
			)
		);
