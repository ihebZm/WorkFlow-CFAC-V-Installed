...
<li>Het beheren van het belangrijkste middel: documentatie.</li>
	...
	'UI:WelcomeMenu:Text' => '<div>Proficiat, je werkt nu met iTop Fullmoon!</div>

<div>Deze versie heeft een volledig nieuw, modern en toegankelijk uiterlijk.</div>

<div>De belangrijkste en meest vertrouwde iTop functies hebben we behouden en een modern jasje gegeven.
We hopen dat je even hard van deze versie geniet als dat we zelf ervan hebben genoten om het te ontwerpen.</div>

<div>Wijzig je iTop-voorkeuren voor een gepersonaliseerde ervaring.</div>',
...
Bij die koppeling wordt aan elke actie een volgorde-nummer gegeven. Dit bepaalt in welke volgorde de acties moeten worden uitgevoerd.</p>',
	...
	'UI:Layout:ActivityPanel:Tab:Toolbar:Filter:Logs:Menu:Hint' => 'Kies welke logs weergegeven worden op deze tab',
	...
	'UI:Layout:ActivityPanel:Tab:Toolbar:Action:OpenAll:Tooltip' => 'Open alle items',
	'UI:Layout:ActivityPanel:Tab:Toolbar:Action:CloseAll:Tooltip' => 'Sluit alle items',
	...
	'UI:Layout:ActivityPanel:ComposeButton:Tooltip' => 'Voeg item toe',
	'UI:Layout:ActivityPanel:MultipleEntriesSaveConfirmation:Title' => 'Meerdere logs opslaan',
