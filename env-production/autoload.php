<?php
//
// File generated on 2023-03-16T12:14:35+0100
// Please do not edit manually
//
MetaModel::IncludeModule(MODULESROOT.'/core/main.php');
MetaModel::IncludeModule(MODULESROOT.'/approval-base/main.approval-base.php');
MetaModel::IncludeModule(MODULESROOT.'/approval-base/model.approval-base.php');
MetaModel::IncludeModule(MODULESROOT.'/approval-base/compatibilitybridge.php');
...
MetaModel::IncludeModule(MODULESROOT.'/itop-object-copier/main.itop-object-copier.php');
...
MetaModel::IncludeModule(MODULESROOT.'/itop-stencils/main.itop-stencils.php');
...
MetaModel::IncludeModule(MODULESROOT.'/templates-base/model.templates-base.php');
...
MetaModel::IncludeModule(MODULESROOT.'/customer-survey/main.customer-survey.php');
MetaModel::IncludeModule(MODULESROOT.'/customer-survey/model.customer-survey.php');
...
MetaModel::IncludeModule(MODULESROOT.'/itop-communications/model.itop-communications.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-communications/compatibilitybridge.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-request-template/model.itop-request-template.php');
MetaModel::IncludeModule(MODULESROOT.'/itop-request-template/main.itop-request-template.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-approval-extended/model.combodo-approval-extended.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-approval-extended/main.combodo-approval-extended.php');
...
return array (
  ...
  'approval-base' => 
  array (
    'root_dir' => $sCurrEnv.'/approval-base',
    'version' => '3.2.2',
  ),
  'authent-cas' => 
  array (
  ...
  'itop-object-copier' => 
  array (
    'root_dir' => $sCurrEnv.'/itop-object-copier',
    'version' => '1.4.3',
  ),
  'itop-portal-base' => 
  array (
  ...
  'itop-stencils' => 
  array (
    'root_dir' => $sCurrEnv.'/itop-stencils',
    'version' => '1.0.6',
  ),
  'itop-structure' => 
  array (
  ...
  array (
    'root_dir' => $sCurrEnv.'/molkobain-portal-mosaic-service-catalog',
    'version' => '1.0.0',
  ),
  'templates-base' => 
  array (
    'root_dir' => $sCurrEnv.'/templates-base',
    'version' => '3.0.17',
  ),
  'combodo-db-tools' => 
  array (
  ...
  array (
    'root_dir' => $sCurrEnv.'/itop-approval-portal',
    'version' => '1.0.7',
  ),
  'itop-config-mgmt' => 
  array (
  ...
  'customer-survey' => 
  array (
    'root_dir' => $sCurrEnv.'/customer-survey',
    'version' => '2.5.2',
  ),
  ...
  'itop-communications' => 
  array (
    'root_dir' => $sCurrEnv.'/itop-communications',
    'version' => '1.2.0',
  ),
  'itop-full-itil' => 
  array (
  ...
  array (
    'root_dir' => $sCurrEnv.'/itop-request-template',
    'version' => '2.0.5',
  ),
  'combodo-approval-extended' => 
  array (
    'root_dir' => $sCurrEnv.'/combodo-approval-extended',
    'version' => '1.4.0',
  ),
  'itop-request-template-portal' => 
  array (
    'root_dir' => $sCurrEnv.'/itop-request-template-portal',
    'version' => '1.0.0',
  ),
);
}
