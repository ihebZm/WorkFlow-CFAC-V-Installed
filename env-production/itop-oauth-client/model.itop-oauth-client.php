...
/**
 * Classes and menus for itop-oauth-client (version 3.0.2)
 *
...
abstract class OAuthClient extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("mailbox_list", array("linked_class"=>'MailInboxOAuth', "ext_key_to_me"=>'oauth_client_id', "count_min"=>0, "count_max"=>0, "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class OAuthClientAzure extends OAuthClient
{
  ...
  array (
    ...
    'is_blocking' => true,
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeEnumSet("scope", array("allowed_values"=>null, "possible_values"=>new ValueSetEnumPadded("SMTP,IMAP"), "sql"=>'scope', "is_null_allowed"=>true, "depends_on"=>array(), "max_items"=>12, "always_load_in_tables"=>true)));
		MetaModel::Init_AddAttribute(new AttributeString("advanced_scope", array("allowed_values"=>null, "sql"=>'advanced_scope', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("used_scope", array("allowed_values"=>new ValueSetEnum("simple,advanced"), "display_style"=>'list', "sql"=>'used_scope', "default_value"=>'simple', "is_null_allowed"=>false, "depends_on"=>array('scope', 'advanced_scope'), "always_load_in_tables"=>true)));
		MetaModel::Init_AddAttribute(new AttributeEnum("used_for_smtp", array("allowed_values"=>new ValueSetEnum("yes,no"), "display_style"=>'list', "sql"=>'used_for_smtp', "default_value"=>'no', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>true)));
