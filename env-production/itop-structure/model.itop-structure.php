...
class Organization extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("status", array("allowed_values"=>new ValueSetEnum("active,inactive,unpaid"), "styled_values"=>['active' =>  new ormStyle('ibo-dm-enum--Organization-status-active', 'ibo-dm-enum-alt--Organization-status-active', 'var(--ibo-dm-enum--Organization-status-active--main-color)', 'var(--ibo-dm-enum--Organization-status-active--complementary-color)', null, null),'inactive' =>  new ormStyle('ibo-dm-enum--Organization-status-inactive', 'ibo-dm-enum-alt--Organization-status-inactive', 'var(--ibo-dm-enum--Organization-status-inactive--main-color)', 'var(--ibo-dm-enum--Organization-status-inactive--complementary-color)', null, null),'unpaid' =>  new ormStyle('ibo-dm-enum--Organization-status-unpaid', 'ibo-dm-enum-alt--Organization-status-unpaid', 'var(--ibo-dm-enum--Organization-status-unpaid--main-color)', 'var(--ibo-dm-enum--Organization-status-unpaid--complementary-color)', null, null)], "display_style"=>'list', "sql"=>'status', "default_value"=>'active', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
