...
define('ITOP_APPLICATION', 'My-CFAC');
define('ITOP_APPLICATION_SHORT', 'My-CFAC');
 ...
 */
define('ITOP_VERSION', '3.0.2-1');

define('ITOP_VERSION_NAME', 'Fullmoon');
define('ITOP_REVISION', '9957');
define('ITOP_BUILD_DATE', '2022-09-12 14:08:58');
...
class Config
{
	...
	protected $m_aSettings = [
		...
		'app_icon_url' => [
			...
			'default' => 'http://www.cfacgroup.com/fr/article/presentation_7/2',
			'value' => '',
			'source_of_value' => '',
			'show_in_conf_sample' => false,
		],
